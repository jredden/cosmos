...
public class GenerateAtmosphereTest4 {
	...
	Logger logger = LoggerFactory.getLogger(GenerateAtmosphereTest4.class);
	...
	private static int numberTests = 100;
...
//		generateAtmosphere = (GenerateAtmosphere) runTimeLikeSetup.getBean("generateAtmosphere");
		...
		while (numberTests > 0){
			...
			AtmosphereDTO atmosphereDTO = generateAtmosphere.genAtmosphereNormalized(lumens, distanceInAus, size, color);
