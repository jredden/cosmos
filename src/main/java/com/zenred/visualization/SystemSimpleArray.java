...
public class SystemSimpleArray {
	...
	private List<List<Object>> clusterRepList;
	private List<List<Object>> starRepList;

	/*
	 * Cluster indexes for JSON
	 * 
	 * _angleInRadians: 4.642575810304916 _clusterDescription:
	 * "Cluster Number: 0 FOURSTAR_SPREAD" _clusterId: "U99998V100002_0"
	 * _datestamp: Object _distanceSysVirtCentre: 68413793103.44827
	 * _numberStarsInCluster: 4 _planetsAllowed: "F" _systemId: "U99998V100002"
	 */
	...
	/**
	 * 
	 * _starId:252," _systemId:"U99999V100000" _clusterId:"U99999V100000_0"
	 * _distanceClustVirtCentre:9.92E11 _luminosity:2.2993541664570722
	 * _noPlanetsAllowed":"F" _angleInRadiansS":152 _starColor":pyel.mains
	 * _starType:"f6 _starSize:39.6}
	 */
	...
	public static SystemSimpleArray genSimpleArray(
			SystemPlusSomeDetails systemPlusSomeDetails) {
		...
		systemsSimpleArray._distanceToGalaxyCentre = systemPlusSomeDetails
				.get_distanceToGalaxyCentre();
		systemsSimpleArray._ucoordinate = systemPlusSomeDetails
				.get_ucoordinate();
		systemsSimpleArray._vcoordinate = systemPlusSomeDetails
				.get_vcoordinate();
		systemsSimpleArray._systemId = systemPlusSomeDetails.get_systemId();
		systemsSimpleArray.clusterRepList = new ArrayList<List<Object>>();
		systemsSimpleArray.starRepList = new ArrayList<List<Object>>();

		for (int index = 0; index < systemPlusSomeDetails.getClusterRepList()
				.size(); index++) {
			ClusterRep clusterRep = systemPlusSomeDetails.getClusterRepList()
				...
				aCluster.add(CLUSTER_DESCRIPTION,
						clusterRep.get_clusterDescription());
				aCluster.add(DISTANCE_VIRTUAL_CENTRE,
						clusterRep.get_distanceSysVirtCentre());
				aCluster.add(NUMBER_STARS_IN_CLUSTER,
		...
		for (int index = 0; index < systemPlusSomeDetails.getStarRepList()
			...
			aStar.add(DISTANCE_TO_CLUSTER_VIRT_CENTRE,
					starRep.getDistanceClustVirtCentre());
	...
	/**
	 * @param distanceToGalaxyCentre
	 *            the _distanceToGalaxyCentre to set
	 */
	...
	/**
	 * @param vcoordinate
	 *            the _vcoordinate to set
	 */
	public void set_vcoordinate(String vcoordinate) {
		_vcoordinate = vcoordinate;
	}

	public List<List<Object>> getClusterRepList() {
		return clusterRepList;
	}

	public void setClusterRepList(List<List<Object>> clusterRepList) {
		this.clusterRepList = clusterRepList;
	}

	public List<List<Object>> getStarRepList() {
		return starRepList;
	}

	public void setStarRepList(List<List<Object>> starRepList) {
