...
public enum AtmosphereParts {
    ...
    SulfuricAcid("sulfuric_acid", "h[1]so[4]", 283.15, 613.15),
    CarbonDioxide("carbon_dioxide", "co[1]", 194.5, 216.5),
    Nitrogen("nitrogen", "n[1]", 64.0, 78.0),
    Ammonia("ammonia", "nh[3]", 195.3, 239.6),
    NitrogenDioxide("nitrogen_dioxide", "no[1]", 261.8, 294.2),
    Oxygen("oxygen", "o[1]", 54.6, 90.0),
    Water("water", "h[2]o", 273.0, 373.0),
    Neon("neon", "ne[1]", 24.6, 27.1),
    HydrogenSulfide("hydrogen_sulfide", "h[1]s", 187.5, 212.3),
    SulferDioxide("sulfer_dioxide", "so[1]", 200.8, 263.0),
    Chlorine("chlorine", "cl[1]", 171.9, 238.4),
    Argon("argon", "ar[1]", 83.8, 87.4),
    Helium("helium", "he[1]", 1.0, 1.15),
    Hydrogen("hydrogen", "h[1]", 14.01, 33.0),
    HydrocloricAcid("hydrocloric_acid", "h[1]cl[1]", 247.0, 523.15),
    CarbonMonoxide("carbon_monoxide", "co[1]", 67.9, 83.0),
